...
^^Написання комп'ютерних програм (**програмування**)^^ - напрочуд цінна навичка сьогодення.  
...
Щороку ростуть вимоги до програмістів-початківців. Тому ==чим раніше почнете, тим більшу фору матимете :material-emoticon-wink-outline:{ .lg }==. Досвід програмування у дитинстві та юнацькому віці допомагає формувати свідомість майбутнього інженера.  
...
???+ info "Терміни"
    Деякі терміни, що зустрічаються в книжках з програмування є ^^універсальними^^ для всіх мов та не міняють свого значення, тобто є такими, що кожен програміст приблизно розуміє. Серед них 2 таких терміни як ==Вираз== та ==Твердження==. В контексті програмування ці терміни мають своє особливе значення. Пояснимо ^^на прикладі^^.  
...
???+ tip "Присвоїти"
    Звертаємо твою увагу, що знак `=` в мовах програмування нерідко значить `присвоїти` (assign), а не ~~`дорівнює`~~, як ми звикли з математики
